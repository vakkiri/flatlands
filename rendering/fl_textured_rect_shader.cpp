...
void FLTexturedRectShader::set_tex_coord_pointer(GLsizei stride,
												 const GLvoid *data) {
	glVertexAttribPointer(intex_coord_location, 2, GL_FLOAT, GL_FALSE, stride,
						  data);
}
...
GLint FLTexturedRectShader::get_id() { return program_id; }
