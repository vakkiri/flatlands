...
#define FL_POS_SEND_INTERVAL                                                   \
	20 // how often in ms we update the player's position
#define FL_RESEND_INTERVAL                                                     \
	200 // how often we resend messages needing confirmation
